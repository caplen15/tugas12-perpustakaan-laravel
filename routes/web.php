...
//     $html .= '<h2>Buku dengan Status Stok Badge</h2><ul>';
//     foreach (Buku::all() as $buku) {
//         $html .= '<li>' . $buku->judul . ' - ' . $buku->status_stok_badge . ' (' . $buku->tahun_label . ')</li>';
//     }
//     $html .= '</ul>';

//     $html .= '<h2>Buku Terbaru</h2><ul>';
//     foreach (Buku::terbaru()->get() as $buku) {
//         $html .= '<li>' . $buku->judul . ' (' . $buku->tahun_terbit . ')</li>';
//     }
//     $html .= '</ul>';

//     $html .= '<h2>Buku Stok Menipis</h2><ul>';
//     foreach (Buku::stokMenipis()->get() as $buku) {
//         $html .= '<li>' . $buku->judul . ' - Stok: ' . $buku->stok . '</li>';
//     }
//     $html .= '</ul>';

//     $html .= '<h2>Status Badge Anggota</h2><ul>';
//     foreach (Anggota::all() as $anggota) {
//         $html .= '<li>' . $anggota->nama . ' - ' . $anggota->status_badge . '</li>';
//     }
//     $html .= '</ul>';

//     $html .= '<h2>Kategori Usia Anggota</h2><ul>';
//     foreach (Anggota::all() as $anggota) {
//         $html .= '<li>' . $anggota->nama . ' - ' . $anggota->kategori_usia . '</li>';
//     }
//     $html .= '</ul>';

//     $html .= '<h2>Anggota Terdaftar Bulan Ini</h2><ul>';
